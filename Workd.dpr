...
function cmpArrAndStr(arr:LongNum;Str:string):boolean;
var
  i:integer;
  isEqual:Boolean;
begin
...
begin
  ...
  b:=EnterNum(nb,k);
  numdiv := Divide(a,b,na,nb,nrez);
  currnum := Multiply(numdiv,b,na,nb,nrez);
